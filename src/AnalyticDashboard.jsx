...
function AnalyticDashboard() {
  return (
    <div className="flex h-screen w-full bg-[#f8fafc]">
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col p-4 gap-y-6">
        <div className="flex items-center gap-2 px-2 py-3">
          <div className="w-8 h-8 bg-[#10b981] rounded-lg flex items-center justify-center text-white font-bold text-xs">
            R
          </div>
          <div>
            <h2 className="text-sm font-bold text-gray-800 leading-tight">ResumeAI</h2>
            <p className="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Pro</p>
          </div>
        </div>
