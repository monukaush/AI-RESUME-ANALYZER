  ...
  return (
    ...
    <div className="bg-[#f7f9fb] text-[#191c1e] font-sans overflow-x-hidden min-h-screen">
      <main className="pt-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 space-y-6 relative z-10">
              ...
              <h1 className="text-5xl lg:text-6xl font-extrabold tracking-tight text-black leading-tight">
                ...
                <span className="text-[#006c49]">AI-Powered</span> Insights.
              </h1>
              <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
                Upload your resume and let our AI engine scan for gaps, optimize
                keywords, and calculate your competitive score in seconds. Get
                hired faster by top-tier tech companies.
              </p>
              {/* REMOVE THE OLD /Register LINK AND PASTE YOUR NEW /dashboard LINK HERE: */}
              <Link
                to="/dashboard"
                className="bg-gradient-to-r from-[#10B981] to-[#059669] text-white px-10 py-5 rounded-xl font-bold text-lg hover:scale-105 transition-transform inline-block"
              >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                <Link
                  to="/Register"
                  className="w-full sm:w-auto bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-2.5 rounded-xl font-semibold transition-all active:scale-95 flex items-center justify-center gap-2 shadow-sm text-sm "
                >
                  Get Started Free
                ...
                <button
                  ...
                  className="w-full sm:w-auto border border-gray-200 px-8 py-4 rounded-xl font-semibold hover:bg-[#f7f9fb] transition-all flex items-center justify-center gap-2 bg-red-400"
                >
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div
                className="absolute -top-6 -right-6 bg-white p-4 rounded-xl shadow-xl flex items-center gap-3 border border-gray-100 animate-bounce"
        ...
        <section
          id="features"
          className="bg-white py-16 px-6 border-y border-gray-100"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-base text-gray-600 max-w-2xl mx-auto">
                Analyze your resume with AI, identify skill gaps, and measure your ATS match against specific job descriptions.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl border border-gray-100 hover-lift bg-white shadow-sm">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  Get a real-time "Hireability Score" based on current market
                  demands and specific job descriptions. Know exactly where you
                  stand.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-gray-100 hover-lift bg-white shadow-sm">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  Identify missing technical skills and soft skills that ATS
                  filters look for. Automatically inject them into your
                  experience sections.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-gray-100 hover-lift bg-white shadow-sm">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  No more waiting days for feedback. Our AI provides
                  line-by-line improvement suggestions for impact, tone, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            <div className="lg:col-span-8 bg-[#131b2e] rounded-2xl p-8 text-white relative overflow-hidden flex flex-col justify-between min-h-[400px]">
              <div className="relative z-10">
                <span className="bg-[#006c49] text-white px-3 py-1 rounded-full text-xs font-bold mb-4 inline-block">
                  NEW FEATURE
                </span>
                ...
                <p className="text-sm text-gray-300 max-w-md leading-relaxed">
                  Paste a LinkedIn job URL and we'll instantly rewrite your
                  bullet points to match the exact requirements of that role.
                </p>
              </div>
              <div className="mt-8 relative z-10 bg-white/10 backdrop-blur-md border border-white/10 p-4 rounded-xl text-black">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-white/70">
                    Matching for: "Senior Product Designer"
                  </span>
                  <span className="text-[#6cf8bb] font-bold text-sm">
                    92% Match
                  </span>
                </div>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 rounded bg-[#006c49]/30 text-[#6cf8bb] text-[10px] font-bold">
                    FIGMA
                  </span>
                  <span className="px-2 py-1 rounded bg-[#006c49]/30 text-[#6cf8bb] text-[10px] font-bold">
                    SYSTEMS DESIGN
            ...
            <div className="lg:col-span-4 bg-white border border-gray-100 rounded-2xl p-8 flex flex-col justify-center items-center text-center space-y-4 shadow-sm">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Our templates are 100% compliant with major ATS systems like
                Workday, Lever, and Greenhouse.
              </p>
          ...
          <div className="max-w-4xl mx-auto rounded-3xl bg-black text-white p-8 md:p-12 text-center relative overflow-hidden">
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-base text-gray-300 max-w-xl mx-auto">
                Join over 50,000 professionals who used AI to optimize their
                career trajectory. No credit card required to start.
              </p>
              <Link
                to="/Register"
                className="bg-gradient-to-r from-[#10B981] to-[#059669] text-white px-10 py-5 rounded-xl font-bold text-lg hover:scale-105 transition-transform inline-block"
      ...
      <footer className="w-full py-8 px-6 flex flex-col md:flex-row justify-between items-center bg-[#f7f9fb] border-t border-gray-200/50">
        <div className="flex items-center gap-2 mb-4 md:mb-0">
          <img
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuBRzLdfwRTuMfU7mtBRjk5tBfmPgxUBknXXkiiBMe8eK_RsAGjMj1sEDR_eUiRbXt0O6G6BsruQqAMrL3HcyutfKQrXi-XvXyuAPtJV-GySWOcP-6MAsJcrOUhjQ8C6Zawr5iybGwbAKp_gGgnViUvCxlcz89LCazidoSGb7axz9BrgDZi2I9p8nRj-XJPO8g9WN8S6bNQ9Jop3y_7oNSid4bhIRUY31n8pMEh9QkNhZM8b0bA7rKSojA"
          />
          <span className="text-xl font-bold text-black">ResumeAI</span>
        </div>
        <div className="flex gap-6 text-sm text-gray-500">
          <a className="hover:text-[#006c49] transition-colors" href="#privacy">
            Privacy Policy
          </a>
          <a className="hover:text-[#006c49] transition-colors" href="#terms">
            Terms of Service
          </a>
          <a className="hover:text-[#006c49] transition-colors" href="#contact">
            Contact
          </a>
        </div>
