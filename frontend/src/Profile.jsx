...
const fetchProfile = async () => {
  ...
  skills: skillsArray
      ...
      if (!contentType || !contentType.includes("application/json")) {
        throw new Error("Server returned non-JSON response. Check Django backend logs.");
      }

      const result = await response.json();

      if (response.ok) {
        const updatedProfile = result.profile || formData;
        setProfileData({ ...updatedProfile, skills: skillsArray });
        setFormData({
          ...updatedProfile,
    ...
    <div className="max-w-4xl mx-auto space-y-6 p-4">
      ...
      {isEditing ? (
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 sticky bottom-4 bg-white/90 backdrop-blur p-4 rounded-xl border border-gray-200 shadow-lg">
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-2.5 text-sm font-semibold text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 disabled:opacity-50 transition-colors"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <h4 className="text-sm font-semibold text-gray-700 group-hover:text-indigo-600 mt-0.5">
                    {profileData.github ? "View Profile" : "Not connected"}
                  </h4>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <h4 className="text-sm font-semibold text-gray-700 group-hover:text-indigo-600 mt-0.5">
                    {profileData.linkedin ? "Connect" : "Not connected"}
                  </h4>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <h4 className="text-sm font-semibold text-gray-700 group-hover:text-indigo-600 mt-0.5">
                    {profileData.leetcode ? "View Solved" : "Not connected"}
                  </h4>
                </div>
              </a>
            </div>
